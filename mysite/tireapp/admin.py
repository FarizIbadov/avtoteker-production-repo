...
from .models import Tire,Size,OneSTire, OsTireImporterSetting
from import_export.admin import ImportExportMixin,ImportMixin
from utils.admin import CustomModelAdmin
from .resources import TireResource,  OneSTireResource, OsTireImporter
...
class OsTireImporterSetting(admin.ModelAdmin):
    pass
